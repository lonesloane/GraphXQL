...
(
    ...
    test:load-test-file("event-1.xml", xdmp:database(), "http://one.oecd.org/event/1"),
    xdmp:document-set-collections('http://one.oecd.org/event/1', ('/test/data', 'http://one.oecd.org/events')),

    test:load-test-file("document-1.xml", xdmp:database(), "http://one.oecd.org/document/1"),
    xdmp:document-set-collections('http://one.oecd.org/document/1', ('/test/data', 'http://one.oecd.org/documents')),

    test:load-test-file("delegation-1.xml", xdmp:database(), "http://one.oecd.org/delegation/1"),
    xdmp:document-set-collections('http://one.oecd.org/delegation/1', ('/test/data', 'http://one.oecd.org/delegations')),
